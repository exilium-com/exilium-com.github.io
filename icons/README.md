...
Insert the following code in the `head` section of your pages:
    ...
    <link rel="mask-icon" href="/icons/safari-pinned-tab.svg" color="#0e7892">
    <link rel="shortcut icon" href="/icons/favicon.ico">
    <meta name="apple-mobile-web-app-title" content="exilium">
    <meta name="application-name" content="exilium">
    <meta name="msapplication-TileColor" content="#0e7892">
